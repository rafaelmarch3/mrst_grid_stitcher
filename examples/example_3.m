...
fluid2 = initSimpleADIFluid('phases', 'WO',...
                                'c', [1e-11,1e-11]/psia,...
                                'n', [2,2],...
                                'mu',[1, 1]*centi*poise,...
                                'rho',[1000, 0.01]);
...
%% Set up model
gravity reset off;
model = TwoPhaseOilWaterModel(G1, rock1, fluid1);
...
model = gridStitcher.stitch(model, {G2}, {rock2}, {fluid2}, connections, transfer_models);
