classdef GridStitcherPoreVolume < StateFunction
    % Effective pore-volume after pressure-multiplier
    properties
    end
    
    methods
        function gp = GridStitcherPoreVolume(model, varargin)
...
%             for i = 1:length(model.G.StitchedGrids.domains)
%                 
%                 dom = model.G.StitchedGrids.domains{i};
