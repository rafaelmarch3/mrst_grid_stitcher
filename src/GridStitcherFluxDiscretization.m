classdef GridStitcherFluxDiscretization < StateFunctionGrouping
    ...
    methods
        function props = GridStitcherFluxDiscretization(model)
            ...
            props.GravityPotentialDifference = GridStitcherGravityPotentialDifference(model);
